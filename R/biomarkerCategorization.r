...
##' @param fdr Default is 0.05. The co-membership matrix calculation will base on genes with this specified fdr.
...
biomarkerCategorization <- function(studies,afunction,B=10,DEindex=NULL,fdr=NULL,silence=FALSE){
	...
	result <- list(varibility=Tscore * 4, dissimilarity=selfDistDirection, AWres=awres.obs, DEindex=DEindex)
	result
