...
- Huo, Zhiguang, Shaowu Tang, Yongseok Park, and George Tseng. "P-value evaluation, variability index and biomarker categorization for deceptively weighted Fisher's meta-analysis method in omics applications." arXiv preprint arXiv:1708.05084 (2018+). (Submitted)
...
pmatrix <- matrix(0,nrow=nrow(dataExp[[1]]),ncol=length(dataExp)) ## this is the input p-value matrix. ## Each row represent a gene and each column represents a study/tissue.
...
### Visualize the heatmap of the first differential expression pattern for all three tissues.
```{r, fig.show='hold'}
